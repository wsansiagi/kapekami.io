...
<div class="wrapper">
 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <!-- Page Heading -->
        <div class="row">
        <div class="pull-left"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#ModalaAdd"><span class="fa fa-plus"></span> Tambah Pengguna </a></div>
            </h1>
        </div>
        <div class="col-xs-11">
          <div class="box">
            ...
            <form class="form-horizontal" action="<?php echo site_url().'index.php/admin/C_admin/simpan_user'; ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="id_kec" class="form-control" type="text" placeholder="Id pengguna" style="width:335px;" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="level" class="form-control" type="text" placeholder="username" style="width:335px;" required>
                        </div>
                    </div>
                </div>
