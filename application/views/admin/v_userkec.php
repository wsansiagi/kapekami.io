...
<div class="wrapper">
 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <!-- Page Heading -->
        <div class="row">
            <div class="col=md-3">
                <div class="pull-left"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#ModalaAdd"><span class="fa fa-plus"></span> Tambah Admin Kecamatan </a></div>
                <br><br>
            </div>
        </div>
        </div>
            ...
            <form class="form-horizontal" action="<?php echo site_url().'index.php/admin/C_admin/simpan_user'; ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                                <select name="id_kec" id="id_kabkot" class="form-control" type="text" placeholder="Id Kecamatan" style="width:335px;" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <select name="level" class="form-control" type="text" placeholder="username" style="width:335px;" required>
                                ...
                                <option value="adminkecamatan">Admin Kecamatan</option>
                                <option value="adminkepalakecamatan">Admin Kepala Kecamatan</option>
                            </select>
                        </div>
                    </div>
                </div>
