...
<div class="wrapper">
 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <!-- Page Heading -->
        ...
        <div class="pull-left"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#ModalaAdd"><span class="fa fa-plus"></span> Tambah Kabupaten/Kota</a></div>
            </h1>
        </div>
       <div class="col-xs-11">
          <div class="box">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a href="<?php echo base_url('index.php/admin/C_admin/edit_kabkot/'.$row->id_kabkot); ?>" class="btn btn-success btn-sm">Edit</a>
                    <a href="<?php echo base_url('index.php/admin/C_admin/hapus_kabkot/'.$row->id_kabkot); ?>" class="btn btn-danger btn-sm">Hapus</a>
